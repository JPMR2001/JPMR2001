...
* Cloud infrastructure management and provisioning with Azure and AWS
* Containerization and orchestration using Docker and Kubernetes
* Scripting and automation with Linux/Bash and Python
* Infrastructure as Code (IaC) implementation
* Backend development and API integration with Node.js
* Handling SQL databases and version control with Git/GitHub
...
<div align="left">
  ...
  <img width="15" />
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postgresql/postgresql-original-wordmark.svg" height="40" alt="postgresql logo" title="PostgreSQL" />
</div>
